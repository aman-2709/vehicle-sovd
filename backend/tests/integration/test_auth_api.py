...
class TestLoginEndpoint:
    ...
    async def test_login_success(self, async_client: AsyncClient, db_session: AsyncSession):
        ...
        result = await db_session.execute(
            select(Session).where(Session.user_id == user.user_id)
        )
    ...
    @pytest.mark.asyncio
    async def test_login_invalid_password(self, async_client: AsyncClient, db_session: AsyncSession):
...
class TestRefreshEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_not_in_database(self, async_client: AsyncClient, db_session: AsyncSession):
...
class TestRoleBasedAccessControl:
    ...
    @pytest.mark.asyncio
    async def test_require_role_admin_success(self, async_client: AsyncClient, db_session: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_require_role_engineer_blocked(self, async_client: AsyncClient, db_session: AsyncSession):
